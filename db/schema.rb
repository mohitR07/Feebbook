...
ActiveRecord::Schema[7.2].define(version: 2025_05_09_131826) do
  ...
  create_table "reply_comments", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["article_id"], name: "index_reply_comments_on_article_id"
    t.index ["comment_id"], name: "index_reply_comments_on_comment_id"
  end

  add_foreign_key "comments", "articles"
  add_foreign_key "reply_comments", "articles"
